...
def ssd_bboxes_select(predictions_all,
                      anchors_net,
                      select_threshold=0.5,
                      img_shape=(300, 300),
                      num_classes=21,
    ...
    #
    a = 38*38*4
    predictions_net.append(np.reshape(predictions_all[0:a,0:21], newshape=[1,38,38,4,21]))
    localizations_net.append(np.reshape(predictions_all[0:a,21:25], newshape=[1,38,38,4,4]))
    b = a + 19*19*6
    predictions_net.append(np.reshape(predictions_all[a:b,0:21], newshape=[1,19,19,6,21]))
    localizations_net.append(np.reshape(predictions_all[a:b,21:25], newshape=[1,19,19,6,4]))
    c = b + 10*10*6
    predictions_net.append(np.reshape(predictions_all[b:c,0:21], newshape=[1,10,10,6,21]))
    localizations_net.append(np.reshape(predictions_all[b:c,21:25], newshape=[1,10,10,6,4]))
    d = c + 5*5*6
    predictions_net.append(np.reshape(predictions_all[c:d:,0:21], newshape=[1,5,5,6,21]))
    localizations_net.append(np.reshape(predictions_all[c:d:,21:25], newshape=[1,5,5,6,4]))
    e = d + 3*3*4
    predictions_net.append(np.reshape(predictions_all[d:e,0:21], newshape=[1,3,3,4,21]))
    localizations_net.append(np.reshape(predictions_all[d:e,21:25], newshape=[1,3,3,4,4]))
    f = e + 1*1*4
    predictions_net.append(np.reshape(predictions_all[e:f,0:21], newshape=[1,1,1,4,21]))
    localizations_net.append(np.reshape(predictions_all[e:f, 21:25], newshape=[1,1,1,4,4]))
